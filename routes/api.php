...
Route::post('reject/chunks', [SurveyController::class, 'rejectedWithChunks']);
...
Route::get('construction/survey/form/stage4', [ConstructionController::class, 'survey_form_construction_stage4']);
...
Route::post('construction/survey/form/stage4/upload', [ConstructionController::class, 'survey_form_construction_stage4_upload']);
