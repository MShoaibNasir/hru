    ...
    <div class="container-fluid pt-4 px-4 form_width">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">Environment Mitigation Report</h6>
            </div>
            ...
            <div class="col-md-12">
                                  ...
                                  <!--Toolbar-->
                                    	<div class="toolbar">
                                            ...
                                            <div class="filters-toolbar__item mb-3 col-md-3">
                                                ...
                                                {!! Form::select('action_condition', ['R' => 'Reject Cases', 'A' => 'Resolve Cases','P'=>'Pending Cases'], 'P', array('placeholder' => 'Select Case Status', 'class' => 'action_condition form-control select2', 'id'=>'action_condition')) !!}
                                            </div>
                                            <div class="filters-toolbar__item mb-3 col-md-3">
                                                <label class="form-label">{{ __('Checklist Name') }}</label>
                                                {!! Form::select('form_name', ['34' => 'Zoning & Land Use Planning', '35' => 'Soil & Land Contamination','36'=>'Water Contamination','37'=>'Noise and Air Pollution','38'=>'Flora and Fauna'],null, array('placeholder' => 'Select Checklist Name', 'class' => 'form_name form-control select2', 'id'=>'form_name')) !!}
                                            </div>
                                            
                                           {{-- <div class="filters-toolbar__item mb-3 col-md-3">
                                                <label class="form-label">{{ __('Department') }}</label>
                                                {!! Form::select('department', [ '48' => 'HRU Finance'], null, array('placeholder' => 'Select Department', 'class' => 'department form-control select2', 'id'=>'department')) !!}
                                            </div> --}}
                ...
                <div class="row">										
                									...
                									<div class="filters-toolbar__item mb-3 col-md-4">
                                                      ...
                                                      {{ Form::select('sorting',[ 'id' => 'Environment Case Id', 'ref_no' => 'Refrence Number'],'id',['class'=>'form-control', 'id'=>'sorting']) }}
                                                    </div>
...
<x-backend.environmentCase.reporttrail_modal />
@endsection
@push('ayiscss')
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage)
    {
       ...
       $.ajax({
          type: 'POST',
          data:{action:action, stage:stage,form_name:form_name, action_condition:action_condition, department:department, lot_id:lot_id, district_id:district_id, tehsil_id:tehsil_id, uc_id:uc_id, b_reference_number:b_reference_number, beneficiary_name:beneficiary_name, cnic:cnic, sorting:sorting, direction:direction, qty:qty, ayis_page:ayis_page, _token: '{{csrf_token()}}'},
          url: "{{ route('environment_case.fetch_datalist') }}",
    ...
    $('body').on('change', '#sorting,#form_name,#direction, #qty, #stage, #action_condition, #department, #lot_id, #district_id, #tehsil_id, #uc_id', function(e){
            e.preventDefault();
            filter_data();
    });
    ...
    $('body').on('click', '.report_trail_btn', function(e){
        ...
        $.ajax({
              url: "{{ route('environment_case.status_trail_history') }}",
              type: 'GET',
