    ...
    <div class="container-fluid pt-4 px-4 form_width">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">SURVEY FORM MASTER REPORTING OPTIMIZE</h6>
            </div>
            <?php
...
?>
            ...
            <div class="col-md-12">
                                  ...
                                  <!--Toolbar-->
                                    	<div class="toolbar">
                                            ...
                                            <div class="filters-toolbar__item mb-3 col-md-3">
                                            	...
                                            	<div class="row">
                                                    ...
                                                    <div class="row">
                										...
                										{!! Form::select('proposed_beneficiary', ['YES'=>'No', 'No'=>'Yes'], null, ['placeholder' => 'Select Proposed Beneficiary', 'class' => 'proposed_beneficiary form-control select2', 'id'=>'proposed_beneficiary']) !!}
                							...
                							<div class="filters-toolbar__item mb-3 col-md-3">
                										...
                										{!! Form::select('status', ['P'=>'Pending List', 'H'=>'Hold List','A'=>'Approved List','R'=>'Rejected List', '34'=>'Rejected By IP'], 'P', ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										@elseif(Auth::user()->role == 34)
                										{!! Form::select('status', ['P'=>'Pending List', 'H'=>'Hold List','A'=>'Approved List','R'=>'Rejected List', '36'=>'Rejected By HRU'], 'P', ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										@elseif(Auth::user()->role == 36)
                										{!! Form::select('status', ['P'=>'Pending List', 'H'=>'Hold List','A'=>'Approved List','R'=>'Rejected List', '37'=>'Rejected By PSIA'], 'P', ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										@elseif(Auth::user()->role == 37)
                										{!! Form::select('status', ['P'=>'Pending List', 'H'=>'Hold List','A'=>'Approved List','R'=>'Rejected List', '38'=>'Rejected By HRU_MAIN'], 'P', ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										@elseif(Auth::user()->role == 38)
                										{!! Form::select('status', ['P'=>'Pending List', 'H'=>'Hold List','A'=>'Approved List','R'=>'Rejected List', '40'=>'Rejected By CEO'], 'P', ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										@elseif(Auth::user()->role == 40)
                										{!! Form::select('status', ['P'=>'Pending List', 'H'=>'Hold List','A'=>'Approved List','R'=>'Rejected List'], 'P', ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										@elseif(Auth::user()->role == 48)
                										{!! Form::select('status', ['P'=>'Pending List', 'H'=>'Hold List','A'=>'Approved List','R'=>'Rejected List'], 'P', ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										@elseif(Auth::user()->role == 51)
                										{!! Form::select('status', ['P'=>'Pending List'], 'P', ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										@else
                										{!! Form::select('status', ['P'=>'Pending List', 'H'=>'Hold List','A'=>'Approved List','R'=>'Rejected List'], null, ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										@endif
                										</div>
                ...
                <div class="row">
    										...
    										@elseif(Auth::user()->role==51)
    										{!! Form::select('department', ['30' => 'FS', '34' => 'IP', '36' => 'HRU'], 30, array('placeholder' => 'Select Department', 'class' => 'department form-control select2', 'id'=>'department')) !!}
    										@elseif(Auth::user()->role==48)
    										{!! Form::select('department', ['27' => 'Validator', '30' => 'FS', '34' => 'IP', '36' => 'HRU', '37' => 'PSIA', '38' => 'HRU MAIN', '40' => 'CEO', '48' => 'Finance'], Auth::user()->role, array('placeholder' => 'Select Department', 'class' => 'department form-control select2', 'id'=>'department')) !!}
    										@elseif(Auth::user()->role==40)
                                            ...
                                            {{-- Form::hidden('department123',Auth::user()->role,['id'=>'department123']) --}}
                ...
                <div class="row">
                    ...
                    {{ Form::select('tranche',['1' => 'First Tranche', '2' => 'Second Tranche' ,'3' => 'Third Tranche' ,'4' => 'Fourth Tranche'],null,['placeholder' => 'Select Tranche', 'class'=>'form-control', 'id'=>'tranche']) }}
                    </div>										
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage, ayis_survey_id)
    {
       ...
       $.ajax({
          ...
          url: "{{ route('report_survey_datalist_fetch_data_optimize') }}",
