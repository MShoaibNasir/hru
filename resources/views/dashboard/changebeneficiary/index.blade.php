    ...
    <div class="container-fluid pt-4 px-4 form_width">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">Change Beneficiary Report</h6>
                <a href="{{route('changebeneficiary.create')}}" target="_blank" class="create_button">Create Change Beneficiary</a>
            </div>
            ...
            <div class="col-md-12">
                                  ...
                                  <!--Toolbar-->
                                    	<div class="toolbar">
                                            ...
                                            <div class="filters-toolbar__item mb-3 col-md-3">
                                                ...
                                                {!! Form::select('department', ['30' => 'FS', '34' => 'IP', '36' => 'HRU', '37' => 'PSIA', '48' => 'HRU Finance'], null, array('placeholder' => 'Select Department', 'class' => 'department form-control select2', 'id'=>'department')) !!}
                                            </div>
                                            
                                            <div class="filters-toolbar__item mb-3 col-md-3">
                                                <label class="form-label">{{ __('Data Type') }}</label>
                                                {!! Form::select('datatype', ['New' => 'New Data', 'Old' => 'Old Data', 'Both' => 'Both Data'], 'Both', array('placeholder' => 'Select Data Type', 'class' => 'type form-control select2', 'id'=>'datatype')) !!}
                                            </div>
                ...
                <div class="row">										
                									...
                									<div class="filters-toolbar__item mb-3 col-md-4">
                                                      ...
                                                      {{ Form::select('sorting',[ 'id' => 'CB ID', 'ref_no' => 'Refrence Number'],'id',['class'=>'form-control', 'id'=>'sorting']) }}
                                                    </div>
...
<x-backend.changebeneficiary.reporttrail_modal />
@endsection
@push('ayiscss')
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage)
    {
       ...
       $.ajax({
          type: 'POST',
          data:{action:action, department:department, datatype:datatype, lot_id:lot_id, district_id:district_id, tehsil_id:tehsil_id, uc_id:uc_id, b_reference_number:b_reference_number, beneficiary_name:beneficiary_name, cnic:cnic, sorting:sorting, direction:direction, qty:qty, ayis_page:ayis_page, _token: '{{csrf_token()}}'},
          url: "{{ route('fetch_datalist') }}",
    ...
    $('body').on('change', '#sorting, #direction, #qty, #department, #datatype, #lot_id, #district_id, #tehsil_id, #uc_id', function(e){
            e.preventDefault();
            filter_data();
    });
    ...
    $('body').on('click', '.report_trail_btn', function(e){
        ...
        $.ajax({
              url: "{{ route('changebeneficiary_status_trail_history') }}",
              type: 'GET',
              data:{_token: '{{csrf_token()}}', cb_id:cb_id},
              //dataType: 'JSON',
