...
<div class="content">
        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Change Beneficiary Edit Form</h6>
    ...
    @endif
                    ...
                    {!! Form::model($changebeneficiary, ['method' => 'PATCH', 'files'=>'true', 'route' => ['changebeneficiary.update', $changebeneficiary->id], 'class'=>'']) !!}    
                        <fieldset class="border p-3 mb-4">
                        <legend class="mb-3">Reference Number</legend>
                        <div class="row">
                            <div class="mb-3 col-6">
                                <label class="form-label">{{ __('Reference Number') }}*</label>
                                {!! Form::text('ref_no', null, array('placeholder' => 'Reference Number','class' => 'form-control', 'disabled' => 'true', 'required')) !!}
                            </div>
                        </div>
                        </fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-4">
                                ...
                                <div class="mt-3 otherspecifyfield">
                                @if($changebeneficiary->reason_change_beneficiary == 'Other')
                                {!! Form::text('otherspecify', null, array('placeholder' => 'Other Specify','class' => 'form-control', 'required')) !!}
                                @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-4">
                                ...
                                {!! Form::date('cnic_issue_date', Carbon\Carbon::parse($changebeneficiary->cnic_issue_date)->format('Y-m-d'), ['class' => 'form-control', 'max' => Carbon\Carbon::yesterday()->format('Y-m-d')]) !!}
                                
                            </div>
                            <div class="mb-3 col-4">
                                <input type="checkbox" id="lifetime_cnic" name="lifetime_cnic" data-checked="{{ $changebeneficiary->lifetime_cnic ?? 0 }}">
                                <label for="lifetime_cnic">Lifetime CNIC</label>
                                <br />
                                <label class="form-label">{{ __('CNIC Expiry Date') }}*</label>
                                {!! Form::date('cnic_expiry_date', $changebeneficiary->cnic_expiry_date ? Carbon\Carbon::parse($changebeneficiary->cnic_expiry_date)->format('Y-m-d') : '', array('placeholder' => 'CNIC Expiry Date','id'=>'cnic_expiry_date', 'class' => 'form-control', 'required')) !!}
                        ...
                        <div class="row">
                            <div class="mb-3 col-4">
                                ...
                                {!! Form::date('date_of_birth', Carbon\Carbon::parse($changebeneficiary->date_of_birth)->format('Y-m-d'), array('placeholder' => 'Date of Birth', 'class' => 'form-control', 'max' => Carbon\Carbon::yesterday()->format('Y-m-d'))) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12">
                                {!! Form::file('change_beneficiary_image', null, array('class' => '')) !!}
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ __('CNIC Front Photographs') }}</label>
                            </div>
                            <div class="mb-3 col-12">
                                {!! Form::file('cnic_front', null, array('class' => '')) !!}
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ __('CNIC Back Photographs') }}</label>
                            </div>
                            <div class="mb-3 col-12">
                                {!! Form::file('cnic_back', null, array('class' => '')) !!}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="mb-3 col-12">
                                {!! Form::file('evidence_uploads', null, array('class' => '')) !!}
                            </div>
                        ...
                        <button type="submit" class="btn btn-primary">Update Beneficiary Info</button>
                    </form>
                </div>
            </div>
        </div>
...
$("#mask_cnic_kin").inputmask("99999-9999999-9", {"clearIncomplete":true});
    ...
    $('body').on('change', '.otherspecify', function(e){
     e.preventDefault();
		...
		if(reason_id == 'Other'){
		//alert(reason_id);
		 $('.otherspecifyfield').html('<input type="text" name="otherspecify" placeholder="Other Specify Here" value="{{ $changebeneficiary->otherspecify ?? '' }}" class="form-control" required>');   
		}else{
...
$('body').on('change', '#lifetime_cnic', function(){
    ...
    if ($('#lifetime_cnic').data('checked') == 1) {
        $('#lifetime_cnic').prop('checked', true);
        $('#cnic_expiry_date').prop('disabled', $('#lifetime_cnic').is(':checked'));
    }
