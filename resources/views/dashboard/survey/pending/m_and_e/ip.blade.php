    ...
    <div class="container-fluid pt-4 px-4 form_width">
        <div class="bg-light text-center rounded p-4">
            ...
            <div class="table-responsive">
                <table class="table text-start align-middle table-bordered table-hover mb-0" id="my_table">
                    <thead>
                        <!--for admin role-->
                        <tr class="text-dark">
                    ...
                    <tbody>
                        ...
                        @foreach($survey_data as $item)
                            ...
                            @php
                            $seniorpost=\DB::table('form_status')->where('form_id',$item->survey_form_id)->where('update_by','HRU')->first();
                            ...
                            <tr style='background-color: {{$item->priority==1? '#19875433' : 'transparent'}}';>
                                ...
                                <input type='hidden' value='IP' class='update_by'>
