                        ...
                        @foreach($survey_data as $item)
                            @php
                                ...
                                if(Auth::user()->role==40){
                                  $another_junior=form_status($item->survey_form_id,'COO');
                                  $show_data=true;
                                }
                                else{
                                $lower_role_name=lower_role_name();
                                $junior=form_status($item->survey_form_id,$lower_role_name);
                                $show_data=true;
                                ...
                                if(isset($another_junior) && $another_junior->form_status=='A'){
                                    $show_data=true;
                                }
