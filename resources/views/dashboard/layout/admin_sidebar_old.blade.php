            ...
            <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        ...
                        @if(Auth::user()->role==1  ||  Auth::user()->role==48)
                            ...
                            <a href="{{route('first_batch_list')}}" class="dropdown-item">View Batch Trench</a>
...
@endif
          ...
          {{-- href="{{route('suvery_pending_data_ip_by_m_and_e')}}" class="dropdown-item">IP Pending List</a>
            ...
            @endif
            <a href="{{route('survey.approved.form')}}" class="dropdown-item">
                          {{ 
                             Auth::user()->role == 37 ? 'Certified User List' : 'Approved List'
                          }}</a>
           ...
           @endif
            ...
            <br /><hr />
            {{-- //New Routes with filter  --}}
            <?php $role = upper_role_id_master_report(); ?>
            <a href="{{route('pending_damage_datalist')}}" class="dropdown-item">Pending list With Filter</a>
            <a href="{{route('approved_damage_datalist')}}" class="dropdown-item">Approved list With Filter</a>
            <a href="{{route('hold_damage_datalist')}}" class="dropdown-item">Hold list With Filter</a>
            <a href="{{route('rejected_damage_datalist')}}" class="dropdown-item">Rejected list With Filter</a>
            <a href="{{route('rejected_upper_damage_datalist')}}" class="dropdown-item">Rejected By {{ $role->name ?? '' }} list With Filter</a>
            <a href="{{route('approved_ceo_damage_datalist')}}" class="dropdown-item">Approved By CEO list With Filter</a>
            ...
            @endphp   
             ...
             <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                     ...
                     @if(Auth::user()->role==1 || Auth::user()->role==30 || Auth::user()->role==34 || Auth::user()->role==36 || Auth::user()->role==37 || Auth::user()->role==38 || Auth::user()->role==40 || Auth::user()->role==51)
