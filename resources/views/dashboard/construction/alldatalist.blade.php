    ...
    <div class="container-fluid pt-4 px-4 form_width">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">CONSTRUCTION REPORT</h6>
            </div>
            ...
            <div class="col-md-12">
                                  ...
                                  <!--Toolbar-->
                                    	<div class="toolbar">
                                            ...
                                            <div class="filters-toolbar__item mb-3 col-md-3">
                								...
                								<div class="filters-toolbar__item mb-3 col-md-3">
                                                <label class="form-label">{{ __('Search By Stage') }}</label>
                                                {!! Form::select('stage', $stage, null, array('placeholder' => 'Select Stage', 'class' => 'stage form-control select2', 'id'=>'stage')) !!}
                                            </div>
                                            ...
                                            <div class="filters-toolbar__item mb-3 col-md-3">
                                                ...
                                                {!! Form::select('department', ['30' => 'FS', '34' => 'IP', '36' => 'HRU', '37' => 'PSIA', '48' => 'HRU Finance'], null, array('placeholder' => 'Select Department', 'class' => 'department form-control select2', 'id'=>'department')) !!}
                                                    ...
                                                    <div class="filters-toolbar__item mb-3 col-md-3">
                										...
                										{!! Form::select('status', ['P'=>'Pending', 'C'=>'Complete', 'A'=>'Approved', 'R'=>'Rejected'], null, ['placeholder' => 'Select Status', 'class' => 'status form-control select2', 'id'=>'status']) !!}
                										</div>
                ...
                <div class="row">										
                									...
                									<div class="filters-toolbar__item mb-3 col-md-4">
                                                      ...
                                                      {{ Form::select('sorting',[ 'id' => 'Construction ID', 'ref_no' => 'Refrence Number'],'id',['class'=>'form-control', 'id'=>'sorting']) }}
                                                    </div>
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage)
    {
       ...
       $.ajax({
          type: 'POST',
          data:{action:action, stage:stage, action_condition:action_condition, department:department, status:status, lot_id:lot_id, district_id:district_id, tehsil_id:tehsil_id, uc_id:uc_id, b_reference_number:b_reference_number, beneficiary_name:beneficiary_name, cnic:cnic, sorting:sorting, direction:direction, qty:qty, ayis_page:ayis_page, _token: '{{csrf_token()}}'},
          url: "{{ route('total_construction_datalist_fetch_data') }}",
    ...
    $('body').on('change', '#sorting, #direction, #qty, #stage, #action_condition, #department, #status, #lot_id, #district_id, #tehsil_id, #uc_id', function(e){
            e.preventDefault();
            filter_data();
    });
    ...
    $('body').on('click', '.report_trail_btn', function(e){
        ...
        $.ajax({
              url: "{{ route('construction_status_trail_history') }}",
              type: 'GET',
