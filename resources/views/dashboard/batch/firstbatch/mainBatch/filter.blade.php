            ...
            <div class="col-md-12">
                ...
                <div class="row">										
                									...
                									<div class="filters-toolbar__item mb-3 col-md-4">
                                                     ...
                                                     <div class="filters-toolbar__item mb-3 col-md-4">
                                                      <label for="Sorting">Batch Status</label>
                                                      {{ Form::select('sorting',[ ''=>'Select Status','1' => 'Complete', '0' => 'In Complete'],null,['class'=>'form-control', 'id'=>'batch_status']) }}
                                                    </div>
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage)
    {
       ...
       $.ajax({
          type: 'POST',
          data:{action:action, district:district, tehsil_id:tehsil_id, uc_id:uc_id,trench:trench, b_reference_number:b_reference_number,bank_name:bank_name,beneficiary_name:beneficiary_name, cnic:cnic, sorting:sorting, direction:direction,batch_status:batch_status, qty:qty, ayis_page:ayis_page, _token: '{{csrf_token()}}'},
          url: "{{ route('main_batch_list') }}",
    ...
    $('body').on('change', '#sorting, #direction, #batch_status,#qty, #district, #tehsil_id, #uc_id, #trench', function(e){
            e.preventDefault();
            filter_data();
    });
