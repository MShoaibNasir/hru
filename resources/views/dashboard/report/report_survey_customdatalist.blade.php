    ...
    <div class="container-fluid pt-4 px-4 form_width">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">FUNCTIONAL LIMITATION REPORTING</h6>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="row">										
                									...
                									<div class="filters-toolbar__item mb-3 col-md-4">
                                                      ...
                                                      {{ Form::select('sorting',[ 'survey_id' => 'Survey ID', 'ref_no' => 'Refrence Number'],'survey_id',['class'=>'form-control', 'id'=>'sorting']) }}
                                                    </div>
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage, ayis_survey_id)
    {
       ...
       $.ajax({
          ...
          url: "{{ route('report_survey_customdatalist_fetch_data') }}",
