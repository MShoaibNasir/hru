...
<div class="content">
    ...
    if (value.length > 13) {
        ...
        function get_filter_pdma() {
            ...
            $.ajax({
                type: "POST",
                url: '{{ route("filterBeneficiaryReportDetail") }}',
                data: {
                ...
                success: function (response) {
                    console.log(response);
                        ...
                        response.data.forEach(item => {
                            console.log('validated_beneficiary:-',item.validated_beneficiary==null);
                            if(item.validated_beneficiary==null){
                                item.validated_beneficiary=0;
                            }
                            $('#table_body').append(`
                                <tr>
                                    <td>${index_number}</td>
