            ...
            <div class="table-responsive">
                <table class="table text-start align-middle table-bordered table-hover mb-0" id='myTable' >
                    ...
                    <tbody>
                            ...
                            $hru_form_status=\DB::table('form_status')->where('form_id',$item->survey_form_id)->where('update_by','HRU_Main')->first();
                            @endphp
                            ...
                            <tr style='background-color: {{$item->priority==1? '#19875433' : 'transparent'}}';>
                                ...
                                <td><input type='checkbox' value='{{$item->survey_form_id}}' class='bulk_survey_id'></td>
    ...
    <script>
        $(document).ready(function(){
         ...
         $(document).ready(function () {
            ...
            var selectedValues = [];
            $(document).on('change', '.bulk_survey_id', function() {
                  var value = $(this).val();
