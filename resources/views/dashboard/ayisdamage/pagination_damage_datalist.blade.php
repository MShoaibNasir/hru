...
<td><a class="btn btn-sm btn-danger report_trail_btn" style="height:30px;" survey_id="{{ $item->id }}" href="javascript:void(0)">Report Trail</a></td>

@if(Auth::user()->role == 48)
<td><a class="btn btn-sm btn-primary finance_trail_btn" style="height:30px;" survey_id="{{ $item->id }}" ref_no="{{ $item->ref_no }}" href="javascript:void(0)">Finance Trail</a></td>
@endif
                            ...
                            <td>
                                ...
                                <td>{{ $item->getsection38->q_2000 ?? '' }}
                                
                                
                                <?php //$location = json_decode($item->getsection38->q_416); 
                                ?>
                                    @if(isset($location[0]->answer))
                                    @if(isset($location[1]->answer))
                                        {{-- $location[0]->answer --}}
                                        {{-- $location[1]->answer --}}                                   
                                    @endif
                                    @endif
