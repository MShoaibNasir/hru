    ...
    <div class="container-fluid pt-4 px-4 form_width">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">DASHBOARD LOG LIST</h6>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="row">										
                									...
                									<div class="filters-toolbar__item mb-3 col-md-4">
                                                      ...
                                                      {{ Form::select('sorting',[ 'id' => 'Log ID', 'ref_number' => 'Ref No'],'id',['class'=>'form-control', 'id'=>'sorting']) }}
                                                    </div>
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage)
    {
       ...
       $.ajax({
          type: 'POST',
          data:{action:action, actions:actions, sections:sections, b_reference_number:b_reference_number, sorting:sorting, direction:direction, qty:qty, ayis_page:ayis_page, _token: '{{csrf_token()}}'},
          url: "{{ route('logdatalist_fetch_data') }}",
    ...
    $('body').on('change', '#sorting, #direction, #qty, #actions, #sections', function(e){
            e.preventDefault();
            filter_data();
    });
