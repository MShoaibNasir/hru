    ...
    <div class="container-fluid pt-4 px-4 form_width">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">VRC Formation</h6>
            </div>
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage)
    {
       ...
       $.ajax({
          type: 'POST',
          data:{action:action, stage:stage, action_condition:action_condition, department:department,item_status:item_status, lot_id:lot_id, district_id:district_id, tehsil_id:tehsil_id, uc_id:uc_id, b_reference_number:b_reference_number, beneficiary_name:beneficiary_name, cnic:cnic, sorting:sorting, direction:direction,form_name:form_name, qty:qty, ayis_page:ayis_page, _token: '{{csrf_token()}}'},
          url: "{{ route('total_vrc_datalist_fetch_data') }}",
