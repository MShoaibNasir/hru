        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Update Designation</h6>
                    <form method="post" action="{{route('designation.update',[$designation->id])}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                         ...
                         <div class="mb-3 col-6">
                                ...
                                <select class='form-control' name='status'>
                                    ...
                                    <option value='0' {{$designation->status==0? 'selected' : ''}}>In active</option>
                                </select>
                            </div>
                        </div>
