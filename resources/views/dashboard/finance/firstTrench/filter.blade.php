        ...
        <div class="bg-light text-center rounded p-4">
            ...
            <div class="col-md-12">
                ...
                <div class="row">										
                                    ...
                                    <form method='post' action='{{route("save_first_trench_value_data")}}'>
                                        @csrf
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage)
    {
       ...
       $.ajax({
          type: 'POST',
          data:{action:action, district:district,trench:trench,tehsil_id:tehsil_id, uc_id:uc_id, b_reference_number:b_reference_number,bank_name:bank_name,beneficiary_name:beneficiary_name, cnic:cnic, sorting:sorting, direction:direction, qty:qty, ayis_page:ayis_page, _token: '{{csrf_token()}}'},
          url: "{{ route('beneficiaryFirstTrenchFetchData') }}",
    ...
    $('body').on('change', '#sorting, #direction, #qty,#trench, #district, #tehsil_id, #uc_id,#bank_name', function(e){
            e.preventDefault();
