    ...
    <div class="container-fluid pt-4 px-4 form_width">
        <div class="bg-light text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">Beneficiaries Verified Account List</h6>
            </div>
            ...
            <div class="col-md-12">
                                            	...
                                            	<div class="row">
                                                      ...
                                                      <label for="Search">Search By CNIC</label>
                                                       {{ Form::text('cnic',null,['class'=>'form-control', 'id'=>'cnic','placeholder'=>'CNIC']) }}
                										...
                										<div class="filters-toolbar__item mb-3 col-md-4">
                                                      <label for="Search">Search By Bank</label>
                ...
                <div class="row">										
                                    ...
                                    <form method='post' action='{{route("get_export_beneficiary_account")}}'>
                                        @csrf
...
$(document).ready(function(){	
    ...
    function filter_data(currentpage)
    {
       ...
       $.ajax({
          type: 'POST',
          data:{action:action, district:district, tehsil_id:tehsil_id, uc_id:uc_id, b_reference_number:b_reference_number,bank_name:bank_name,beneficiary_name:beneficiary_name, cnic:cnic, sorting:sorting, direction:direction, qty:qty, ayis_page:ayis_page, _token: '{{csrf_token()}}'},
          url: "{{ route('beneficiaryAccountVerificationFetchData') }}",
